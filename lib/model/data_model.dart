class DataModel {
  ...
  Null? amplitudeUncertainty;
  Null? amplitudeLowerUncertainty;
  Null? amplitudeUpperUncertainty;
  Null? amplitudeConfidenceLevel;
  Null? amplitudePdfVariableContent;
  Null? amplitudePdfProbabilityContent;
  ...
  Null? periodValue;
  Null? periodUncertainty;
  Null? periodLowerUncertainty;
  Null? periodUpperUncertainty;
  Null? periodConfidenceLevel;
  Null? periodPdfVariableContent;
  Null? periodPdfProbabilityContent;
  ...
  String? filterID;
  String? methodID;
  Null? scalingTimeValue;
  Null? scalingTimeValueMs;
  Null? scalingTimeUncertainty;
  Null? scalingTimeLowerUncertainty;
  Null? scalingTimeUpperUncertainty;
  Null? scalingTimeConfidenceLevel;
  Null? scalingTimePdfVariableContent;
  Null? scalingTimePdfProbabilityContent;
  ...
  Null? creationInfoModificationTime;
  Null? creationInfoModificationTimeMs;
